 ...
 */
package com.steps.targe.helper;
...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "TrustLog.db";
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            user.put("id_number", cursor.getString(cursor.getColumnIndex("id_number")));
